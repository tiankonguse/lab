...
(function(require, requireNative, exports, console, $Array, $Function, $JSON,
...
InjectedScript.prototype = {
            ...
            for (var i = 0; i < names.length; ++i) {
                ...
                try {
                    ...
                    if (descriptor) {
                        ...
                        // Not all bindings provide proper descriptors. Fall
			// back to the writable, configurable property.
     ...
     * 
     * @param {RuntimeAgent.CallArgument}
     *                callArgumentJson
    ...
    _evaluateOn: function(evalFunction, object, objectGroup, expression, isEvalOnCallFrame, injectCommandLineAPI)
    {
        ...
        // Surround the expression in with statements to inject our command line
	// API so that
        // the window object properties still take more precedent than our API
	// functions.
     ...
     * @param {string}
     *                callFrameId
     * @return {*} a stepIn position array ready for protocol JSON or a string
     *         error
     */
     ...
     *                callFrameId or false
     * @param {string|boolean}
     *                functionObjectId or false
     * @param {number}
     *                scopeNumber
     * @param {string}
     *                variableName
     * @param {string}
     *                newValueJsonString RuntimeAgent.CallArgument structure
    ...
    {
        // document.all is reported as undefined, but we still want to process
	// it.
    ...
    _subtype: function(obj)
    {
        ...
        // If owning frame has navigated to somewhere else window properties
	// will be undefined.
        return null;
    },
    ...
    _describe: function(obj)
    {
        ...
        if (className === "Object") {
            // In Chromium DOM wrapper prototypes will have Object as their
	    // constructor name,
...
InjectedScript.RemoteObject.prototype = {
     ...
     * @param {!Object}
     *                object
     * @param {!RuntimeAgent.ObjectPreview}
     *                preview
     * @param {!Object}
     *                propertiesThreshold
     * @param {Array.
...
function CommandLineAPI(commandLineAPIImpl, callFrame)
{
    ...
    /**
     * @param {string}
     *                name The name of the method for which a toString method
     *                should be generated.
...
// NOTE: Please keep the list of API methods below snchronized to that in
